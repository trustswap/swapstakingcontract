...
// File @openzeppelin/contracts-ethereum-package/contracts/utils/Arrays.sol@v3.0.0
...
contract SwapStakingContract is Initializable, ContextUpgradeSafe, AccessControlUpgradeSafe, PausableUpgradeSafe, ReentrancyGuardUpgradeSafe {
    ...
    function executeWithdrawal(uint256 withdrawAmount)
    external
    nonReentrant
    whenNotPaused
    {
        ...
        require(withdrawAmount <= stakeDeposit.amount, "[Withdraw] The withdraw amount is higher than stake");
